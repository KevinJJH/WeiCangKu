 ...
 */
public abstract class DialogBase3 extends Dialog {
	protected OnClickListener onSuccessListener;
	protected Context mainContext;
	protected OnClickListener onCancelListener;//提供给取消按钮
	protected OnClickListener onAnotherListener;//第三选项按钮
	...
	private String nameButton1, nameButton2,nameButton3;
	 ...
	 */
	public DialogBase3(Context context) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 设置按钮事件监听
		Button1 = (Button)findViewById(R.id.dialog_button31);
		Button2 = (Button)findViewById(R.id.dialog_button32);
		Button3 = (Button)findViewById(R.id.dialog_button33);

		if(nameButton1 != null && nameButton1.length()>0){
			Button1.setText(nameButton1);
			Button1.setOnClickListener(GetPositiveButtonOnClickListener());
		}
		if(nameButton2 != null && nameButton2.length()>0){
			Button2.setText(nameButton2);
			Button2.setOnClickListener(GetNegativeButtonOnClickListener());
		}
		if(nameButton3 != null && nameButton3.length()>0){
			Button3.setText(nameButton3);
			Button3.setOnClickListener(GetAnotherButtonOnClickListener());
		}
	...
	protected OnDismissListener GetOnDismissListener() {
		return new OnDismissListener(){
			public void onDismiss(DialogInterface arg0) {
				DialogBase3.this.onDismiss();
				DialogBase3.this.setOnDismissListener(null);
				view = null;
				mainContext = null;
				Button1 = null;
				Button2 = null;
	 ...
	 * @return 第三选项按钮单击事件监听
	 */
	protected View.OnClickListener GetAnotherButtonOnClickListener() {
		return new View.OnClickListener() {
			public void onClick(View v) {
	 ...
	 * @param listener
	 */
	public void SetOnAnotherListener(OnClickListener listener){
		onAnotherListener = listener;
	}
	 ...
	 * 取消第三选项按钮单击方法，用于子类定制
	 */
	protected abstract boolean OnClickAnotherButton();
	...
	protected void setNameNegativeButton(String nameNegativeButton) {
		this.nameButton2 = nameNegativeButton;
	}

	/**
	 * @return 第三选项按钮名称
	 */
	protected String getNameAnotherButton() {
		return nameButton3;
	}

	/**
	 * @param nameAnotherButton3 第三选项按钮名称
	 */
	protected void setNameAnotherButton(String nameAnotherButton3) {
		this.nameButton3 = nameAnotherButton3;
	}
}