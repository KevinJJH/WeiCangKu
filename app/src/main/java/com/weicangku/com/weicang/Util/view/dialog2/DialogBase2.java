 ...
 */
public abstract class DialogBase2 extends Dialog {
	...
	private String nameButton1, nameButton2;
	 ...
	 */
	public DialogBase2(Context context) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 设置按钮事件监听
		Button1 = (Button)findViewById(R.id.dialog_button21);
		Button2 = (Button)findViewById(R.id.dialog_button22);
	...
	protected OnDismissListener GetOnDismissListener() {
		return new OnDismissListener(){
			public void onDismiss(DialogInterface arg0) {
				DialogBase2.this.onDismiss();
				DialogBase2.this.setOnDismissListener(null);
				view = null;
				mainContext = null;
				Button1 = null;
				Button2 = null;
