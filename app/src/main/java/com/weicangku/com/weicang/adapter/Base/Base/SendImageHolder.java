...
import com.weicangku.com.weicang.Activity.LookImagetoActichatvity;
...
//    final BmobIMUserInfo info = msg.getBmobIMUserInfo();
    ...
    ImageLoaderFactory.getLoader().loadAvator(iv_avatar,user != null ? user.getAvatar() : null,R.drawable.head);
...
//    ImageLoaderFactory.getLoader().load(iv_picture,TextUtils.isEmpty(message.getRemoteUrl()) ? message.getLocalPath():message.getRemoteUrl(),R.mipmap.ic_launcher,null);
    ImageLoader.getInstance().displayImage(TextUtils.isEmpty(message.getRemoteUrl()) ? message.getLocalPath():message.getRemoteUrl(), iv_picture, DisplayConfig.getDefaultOptions(false,R.drawable.no_image));
//    Glide.with(getContext()).load(TextUtils.isEmpty(message.getRemoteUrl()) ? message.getLocalPath():message.getRemoteUrl()).diskCacheStrategy(DiskCacheStrategy.ALL).into(iv_picture);
...
//          onRecyclerViewListener.onItemClick(getAdapterPosition());
          Intent intent = new Intent(getContext(), LookImagetoActichatvity.class);
          intent.putExtra("helps", TextUtils.isEmpty(message.getRemoteUrl()) ? message.getLocalPath():message.getRemoteUrl());
