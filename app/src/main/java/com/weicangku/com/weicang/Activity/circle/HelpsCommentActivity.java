...
public class HelpsCommentActivity extends ParentWithNaviActivity implements View.OnClickListener {
                    ...
                    public void onItemClick(ActionItem item, int position) {
                        switch (position){
                            case 0:
                                ...
                                break;
                            case 1:
                                InputMethodManager imm = (InputMethodManager)HelpsCommentActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE);
