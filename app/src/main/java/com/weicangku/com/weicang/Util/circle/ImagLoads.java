...
public class ImagLoads {
    private static ImagLoads mInstance = null;
    ...
    private ImagLoads(int threadCount, Type type) {
    ...
    public static ImagLoads getmInstance(){
        if(mInstance==null){
            synchronized (ImagLoads.class){
                if(mInstance==null){
                    mInstance=new ImagLoads(1,Type.LIFO);
                }
            }
        }
        return mInstance;
    ...
    public static ImagLoads getInstance(int threadCount, Type type) {
        if (mInstance == null) {
            synchronized (ImagLoads.class) {
                if (mInstance == null) {
                    mInstance = new ImagLoads(threadCount, type);
                }
            }
        }
        return mInstance;
